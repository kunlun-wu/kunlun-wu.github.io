---
title: "Low Temperature Conductivity and Structural Analysis of Cu-CeO₂ Nanoparticles"
excerpt: |
  <p style="margin-bottom:0; font-size:15px; color:#808080;"> Aug 2023 – May 2025, Paper under review</p>
  <p style="margin-top:0; font-size:15px; color:#505050;">Under guidance of Professor <a href="https://www.apam.columbia.edu/faculty/siu-wai-chan">Siu-Wai Chan</a>, Columbia University, NY</p>
  
  <img src='/images/research/1nanoceria/1.jpg' width="30%" align="right" style="margin-left:10px">
  This project, conducted in collaboration with Xinyi Ma, Zhaowen Lin, and Jianing Zhou, investigates small-polaron conduction in copper-doped nanocrystalline ceria (CeO₂).
  Through impedance spectroscopy, X-ray diffraction, and structural analysis, it examines how Cu incorporation modifies charge-transport behavior and may interact with local defect chemistry, revealing a measurable enhancement in conductivity compared with undoped ceria, suggesting a possible correlation with oxygen-vacancy dynamics previously reported in high-temperature catalytic studies.
...
- Copper nitrate hexahydrate, Cu(NO3)2 ∙ 2.5H2O: `n ∙ 0.046525g` for n% Cu-CeO₂.
...
- duration 1: `4h`
- ramp 2: `120°C/h`
- level 2: `0°C` (This will only cool the pellet to room temperature)
- duration 2: `∞`

<img src='/images/research/1nanoceria/6.jpg' width="40%">

### Electrode Appllication
<img src='/images/research/1nanoceria/8.jpg'>
1. Using a Q-tip, apply colloidal silver paste (Electron Microscopy 12640) thinly onto the top surface of each pellet
2. Paint a microscope slide with a track of electrode paste for about **2cm** long
3. Let both dry for **2 hours**
4. Apply a dab of Ag paste to one end of the track, flip the pellet and stick the painted side onto the dab
5. Let dry for **2 hours**
6. Cut gold wire into **5cm** long sections. Dip one end of each wire into the Ag paste to improve cohesion with pellet/track
...
2. Snake the ends of each gold wire through the holes in the contacts at the end of each copper wire
3. Connect the two wires to the input ports of the impedance analyzer
4. Turn on the impedance analyzer
